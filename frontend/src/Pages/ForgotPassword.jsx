    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <h2 style={styles.title}>
          <span style={styles.kw}>forgot</span>
        ...
        <div style={styles.bottomLink}>
          <span style={{ color: '#75715e' }}>{'// back to '}</span>
...
const styles = {
  ...
  successBox: { background: 'rgba(166,226,46,0.15)', border: '2px solid #a6e22e', color: '#a6e22e', padding: '10px 14px', fontFamily: "'Space Mono', monospace", fontSize: '12px', marginBottom: '20px' },
